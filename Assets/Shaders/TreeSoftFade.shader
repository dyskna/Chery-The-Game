    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag(v2f i) : SV_Target
            {
                ...
                // Light is "in front" if angle difference is within range
                float halfRange = _LightAngleRange * 0.5;
                float isFront = (angleDiff <= halfRange) ? 1.0 : 0.0;
                ...
                float illumination = isFront * distanceFactor * _LightIntensity + _AmbientLight;
